...
//    UIColor* lightColor = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.15];
    UIColor* bigBoxInnerShadowColor = [UIColor colorWithRed:0.313 green:0.725 blue:0.882 alpha:1];
    UIColor* backgroundLightColor = [UIColor colorWithRed:0.313 green:0.725 blue:0.882 alpha:1];
    UIColor* lineLightColor = [UIColor colorWithRed:0.313 green:0.725 blue:0.882 alpha:1];
    UIColor* boxStroke = [UIColor colorWithRed:0.313 green:0.725 blue:0.882 alpha:1];
    
    // overlay gradient colors
    UIColor* darkColor = [UIColor colorWithRed:0.313 green:0.725 blue:0.882 alpha:1];
    UIColor* lightColor = [UIColor colorWithRed:0.313 green:0.725 blue:0.882 alpha:1];
    ...
    CGColorRef backgroundShadow = [UIColor clearColor].CGColor;
